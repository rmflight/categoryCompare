...
Currently you can see that for T10, there are `sum(enrichLists$BP$T10@pvalues <= 0.001)` processes enriched, and `sum(enrichLists$BP$T48@pvalues <= 0.001)` for T48. For KEGG, there are `sum(enrichLists$KEGG$T10@pvalues <= 0.05)` and `sum(enrichLists$KEGG$T48@pvalues <= 0.05)` for T10 and T48, respectively.
