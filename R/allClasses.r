...
setClass("GENccEnrichResult", contains="namedList", representation=representation(categoryName="character", ontology="character", geneAnnMapping="namedList", annDescription="character", graphType="character", overlapType="character"), prototype=prototype(graphType="overlap") )
