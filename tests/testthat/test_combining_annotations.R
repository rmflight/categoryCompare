...
test_that("combining text lists works correctly", {
  expect_equal(out_result, combine_text(list(c1 = c1, c2 = c2), use_names))
  expect_equal(out_result, combine_text(list(c1 = c1, c3 = c3), use_names))
  expect_equal(out_result, combine_text(list(c1 = c2, c3 = c3), use_names))
  expect_equal(out_result, combine_text(list(c1 = c1, c2 = c2, c3 = c3), use_names))
  expect_error(combine_text(list(c1 = c1, c4 = c4), use_names))
})